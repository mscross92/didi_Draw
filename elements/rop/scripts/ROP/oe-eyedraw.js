...
ED.Views.SelectedDoodle = (function() {
	...
	SelectedDoodle.prototype.render = function() {
		...
		for (var i=0; i<doodles.length; i++) {
		    if (doodles[i].className == 'ROPFundus') doodles.splice(i,1);
		}
...
/*! Generated on 29/8/2015 */
ED.scriptTemplates = {
  "doodle-popup": "\n\n\n\n{{#doodle}}\n\t<ul class=\"ed-toolbar-panel ed-doodle-popup-toolbar\">\n\t\t<li>\n\t\t\t{{#desc}}\n\t\t\t\t<a class=\"ed-button ed-doodle-help{{lockedButtonClass}}\" href=\"#\" data-function=\"toggleHelp\">\n\t\t\t\t\t<span class=\"icon-ed-help\"></span>\n\t\t\t\t</a>\n\t\t\t{{/desc}}\n\t\t</li>\n\t\t{{#doodle.isLocked}}\n\t\t\t<li>\n\t\t\t\t<a class=\"ed-button\" href=\"#\" data-function=\"unlock\">\n\t\t\t\t\t<span class=\"icon-ed-unlock\"></span>\n\t\t\t\t\t<span class=\"label\">Unlock</span>\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t{{/doodle.isLocked}}\n\t\t{{^doodle.isLocked}}\n\t\t\t<li>\n\t\t\t\t<a class=\"ed-button\" href=\"#\" data-function=\"lock\">\n\t\t\t\t\t<span class=\"icon-ed-lock\"></span>\n\t\t\t\t\t<span class=\"label\">Lock</span>\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t{{/doodle.isLocked}}\n\t\t<li>\n\t\t\t<a class=\"ed-button{{lockedButtonClass}}\" href=\"#\" data-function=\"moveToBack\">\n\t\t\t\t<span class=\"icon-ed-move-to-back\"></span>\n\t\t\t\t<span class=\"label\">Move to back</span>\n\t\t\t</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a class=\"ed-button{{lockedButtonClass}}\" href=\"#\" data-function=\"moveToFront\">\n\t\t\t\t<span class=\"icon-ed-move-to-front\"></span>\n\t\t\t\t<div class=\"label\">Move to front</div>\n\t\t\t</a>\n\t\t</li>\n\t\t<li>\n\t\t\t{{#doodle.isDeletable}}\n\t\t\t\t<a class=\"ed-button{{lockedButtonClass}}\" href=\"#\" data-function=\"deleteSelectedDoodle\">\n\t\t\t\t\t<span class=\"icon-ed-delete\"></span>\n\t\t\t\t\t<span class=\"label\">Delete</span>\n\t\t\t\t</a>\n\t\t\t{{/doodle.isDeletable}}\n\t\t</li>\n\t</ul>\n\t<div class=\"ed-doodle-info hide\">\n\t\t{{^doodle.isLocked}}\n\t\t\t{{#desc}}\n\t\t\t\t<div class=\"ed-doodle-description\">{{{desc}}}</div>\n\t\t\t{{/desc}}\n\t\t{{/doodle.isLocked}}\n\t</div>\n\t<div class=\"ed-doodle-controls\" id=\"{{drawing.canvas.id}}_controls\" style=\"{{#doodle.isLocked}}display:none;{{/doodle.isLocked}}{{#doodle.completeSketch}}display:none;{{/doodle.completeSketch}}\">\n\t</div>\n\t<span class=\"ed-doodle-description\">\n\t</span>\n\t{{#doodle.isDrawable}}\n\t\t<div id=\"sketchWarning\" style=\"color:#07378e; line-height: normal; font-size: smaller;{{^doodle.warning}}display:none;{{/doodle.warning}}\">*Cannot insert an undefined drawing. Select type or label a custom shape.</div>\n\t\t<ul class=\"ed-freehand-doodle-toolbar\" id=\"{{drawing.canvas.id}}_freehand\" style=\"width: 180px; height: 25px;{{#doodle.isLocked}}display:none;{{/doodle.isLocked}}\">\n\t\t\t<li>\n\t\t\t\t<a class=\"ed-button{{lockedButtonClass}}\" href=\"#\" data-function=\"completeFreehand\" style=\"width:22px; height: 24px;\">\n\t\t\t\t\t<span class=\"icon-ed-complete\"></span>\n\t\t\t\t\t<span class=\"label\">Complete drawing</span>\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t\t<li>\n\t\t\t\t<a class=\"ed-button{{lockedButtonClass}}\" href=\"#\" data-function=\"deleteSelectedDoodle\" style=\"width:20px; height: 24px;\">\n\t\t\t\t\t<span class=\"icon-ed-cancel\"></span>\n\t\t\t\t\t<span class=\"label\">Cancel drawing</span>\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t\t<li>\n\t\t\t\t<a class=\"ed-button{{lockedButtonClass}}\" href=\"#\" data-function=\"undoSquiggle\" style=\"width:22px; height: 24px;\">\n\t\t\t\t\t<span class=\"icon-ed-undo\"></span>\n\t\t\t\t\t<span class=\"label\">Undo stroke</span>\n\t\t\t\t</a>\n\t\t\t</li>\n\t\t</ul>\n\t{{/doodle.isDrawable}}\n\t{{#doodle.isLocked}}\n\t\t<div class=\"ed-doodle-description\">\n\t\t\t<strong>This doodle is locked and cannot be edited.</strong>\n\t\t</div>\n\t{{/doodle.isLocked}}\n{{/doodle}}"
};