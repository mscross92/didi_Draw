...
/**
 * Nasal Arcade - superior
 *
 * @class SupNasalArcade
 * @property {String} className Name of doodle subclass
 * @param {Drawing} _drawing
 * @param {Object} _parameterJSON
 */
ED.SupNasalArcade = function(_drawing, _parameterJSON) {
	this.className = "SupNasalArcade";
	this.title = "superonasal";
...
ED.SupNasalArcade.prototype = new ED.Doodle;
ED.SupNasalArcade.prototype.constructor = ED.SupNasalArcade;
ED.SupNasalArcade.superclass = ED.Doodle.prototype;

ED.SupNasalArcade.prototype.setHandles = function() {
	this.handleArray[0] = new ED.Doodle.Handle(null, true, ED.Mode.Scale, false);
}

ED.SupNasalArcade.prototype.setPropertyDefaults = function() {
...
ED.SupNasalArcade.prototype.setParameterDefaults = function() {
...
ED.SupNasalArcade.prototype.dependentParameterValues = function(_parameter, _value) {
...
ED.SupNasalArcade.prototype.draw = function(_point) {
	var ctx = this.drawing.context;
	
// 	var plusFactor = (this.pBool) ? 67 : 0;
// 	var plusWidth = (this.pBool) ? 3: 1;
// 	
// 	if (this.ppBool) {
// 	    plusFactor = 30;
// 	    plusWidth = 1.5;
...
ED.SupNasalArcade.prototype.isPlus = function() {
