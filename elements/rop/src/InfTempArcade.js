 ...
 */
ED.InfTempArcade = function(_drawing, _parameterJSON) {
	this.className = "InfTempArcade";
	this.title = "inferotemporal";
...
ED.InfTempArcade.prototype = new ED.Doodle;
ED.InfTempArcade.prototype.constructor = ED.InfTempArcade;
ED.InfTempArcade.superclass = ED.Doodle.prototype;

ED.InfTempArcade.prototype.setHandles = function() {
	this.handleArray[0] = new ED.Doodle.Handle(null, true, ED.Mode.Scale, false);
}

ED.InfTempArcade.prototype.setPropertyDefaults = function() {
    ...
    this.parameterValidationArray['ppBool'] = {
	    kind: 'derived',
		type: 'bool',
		animate: false
	};	
	...
	this.parameterValidationArray['pBool'] = {
	    kind: 'derived',
		type: 'bool',
		animate: false
	};
...
ED.InfTempArcade.prototype.setParameterDefaults = function() {
	...
	var point1 = new ED.Point(-220 * this.dir,89.4);
...
ED.InfTempArcade.prototype.dependentParameterValues = function(_parameter, _value) {
...
ED.InfTempArcade.prototype.draw = function(_point) {
...
ED.InfTempArcade.prototype.isPlus = function() {
